...
public class SensorDataProcessor {
            ...
            public double[][] limit;
                // constructor
   public SensorDataProcessor(double[][][] data, double[][] limit) { // name of constructor was faulit 
        this.data = data;
        this.limit = limit;
    }
...
// calculate data
        ...
        BufferedWriter out; // we have to put import Nouf
// Write racing stats data into a file
    try {
    out = new BufferedWriter(new FileWriter("RacingStatsData.txt"));  // we have to put import Nouf
